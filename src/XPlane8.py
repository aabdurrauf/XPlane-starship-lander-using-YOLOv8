# -*- coding: utf-8 -*-
"""
Created on Sun Aug 25 00:01:48 2024

@author: Ammar Abdurrauf
version: 8.0
update:
    launching from far distance - FAILED
...
class XPlane:
    ...
    def set_env(self):
        ...
        # refuel the starship
        self.starship.refuel_starship(fuel=294835*1.8)
        # set the starship orientation
        self.starship.set_position(true_head=90)
                
        # reposition the rocket
        # self.starship.sendDREF('sim/flightmodel/position/local_x', LANDING_CENTER_X-150)
        # self.starship.sendDREF('sim/flightmodel/position/local_z', LANDING_CENTER_Z-80)
        self.starship.set_position(latitude=26.00926, longitude=-98.22555, altitude=64.1)
