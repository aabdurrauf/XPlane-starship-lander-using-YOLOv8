# -*- coding: utf-8 -*-
"""
Created on Mon Aug 26 18:09:35 2024
...
from src.constants10 import Pp2, Ip2, Dp2, Ke2, Pr2, Ir2, Dr2, Ka2, Py2, Iy2, Dy2, Kr2, Pv2, Dv2, Kv2
from src.constants10 import Pp3, Ip3, Dp3, Ke3, Pr3, Ir3, Dr3, Ka3, Py3, Iy3, Dy3, Kr3, Pv3, Dv3, Kv3
from src.constants10 import Pp1, Ip1, Dp1, Pr1, Ir1, Dr1, FLIGTH_DATA_DIR, FLIGTH_DATA_FILENAME, CONTROL_DATA_FILENAME
...
class XPlane:
    ...
    def landing_with_yolo(self, target_altitude, dx_gps, dz_gps):
        
        if not self.target_center == None:
            dx = (self.target_center[0] - CENTER_X) * self.altitude * 0.0012
            dz = (self.target_center[1] - CENTER_Y) * self.altitude * 0.0012
        else:
            dx = dx_gps
            dz = dz_gps
        
        print(f'dx_gps: {dx_gps}\ndx: {dx}\ndz_gps: {dz_gps}\ndz: {dz}\n')
    ...
    def xplane_communication(self):
        ...
        while self.run:
            ...
            if stage == 1:
                ...
                throttle_values = self.landing_with_yolo(target_altitude, self.dx, self.dz)
